...
{
    [PluginActionId("sfx-100-streamdeck-plugin.enableeffectproperty")]
    public class EnableEffectProperty : PluginBase
    {
        ...
        #endregion
        public EnableEffectProperty(SDConnection connection, InitialPayload payload) : base(connection, payload)
        {
        ...
        public override void KeyReleased(KeyPayload payload)
        {
            try
            {
                ...
                {
                    case "Linear":
                        PipeServerConnection.Instance.Channel.EffectLinearEnable(settings.EffectName);
                        break;
                    case "Enable":
                        PipeServerConnection.Instance.Channel.EffectEnable(settings.EffectName);
                        break;
                    case "Mute":
                        PipeServerConnection.Instance.Channel.EffectMuteEnable(settings.EffectName);
                        break;
                    default:
