...
{
    [PluginActionId("sfx-100-streamdeck-plugin.seteffectvalue")]
    public class SetEffectValue : PluginBase
    {
        ...
        #endregion
        public SetEffectValue(SDConnection connection, InitialPayload payload) : base(connection, payload)
        {
        ...
        public override void KeyReleased(KeyPayload payload)
        {
            try
            {
                ...
                {
                    case "Intensity":
                        returnVal = PipeServerConnection.Instance.Channel.EffectIntensitySet(settings.EffectName, settings.Value);
                        break;
                    case "Smoothness":
                        returnVal = PipeServerConnection.Instance.Channel.EffectSmoothingSet(settings.EffectName, settings.Value);
                        break;
                    default:
