    ...
    public class IncrementEffectValues : PluginBase
    {
        ...
        public override void KeyReleased(KeyPayload payload)
        {
            try
            {
                ...
                {
                    case "Intensity":
                        returnVal = PipeServerConnection.Instance.Channel.EffectIntensityIncrement(settings.EffectName, settings.Steps);
                        break;

                    case "Smoothness":
                        returnVal = PipeServerConnection.Instance.Channel.EffectSmoothingIncrement(settings.EffectName, settings.Steps);
                        break;
                    default:
