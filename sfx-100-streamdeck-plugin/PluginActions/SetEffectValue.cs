    ...
    public class SetEffectValue : PluginBase
    {
        ...
        public override void KeyReleased(KeyPayload payload)
        {
            try
            {
                ...
                {
                    case "Intensity":
                        PipeServerConnection.Instance.Channel.EffectIntensitySet(settings.EffectName, settings.Value);
                        break;
                    case "Smoothness":
                        PipeServerConnection.Instance.Channel.EffectSmoothingSet(settings.EffectName, settings.Value);
                        break;
                    default:
