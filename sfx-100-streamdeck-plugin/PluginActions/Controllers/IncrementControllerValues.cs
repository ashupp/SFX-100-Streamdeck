    ...
    public class IncrementControllerValues : PluginBase
    {
        ...
        public override void KeyReleased(KeyPayload payload)
        {
            try
            {
                ...
                {
                    case "Intensity":
                        returnVal = PipeServerConnection.Instance.Channel.ControllerIntensityIncrement(settings.ControllerName, settings.Steps);
                        break;

                    case "Smoothness":
                        returnVal = PipeServerConnection.Instance.Channel.ControllerSmoothnessIncrement(settings.ControllerName, settings.Steps);
                        break;

                    case "Acceleration":
                        returnVal = PipeServerConnection.Instance.Channel.ControllerAccelerationIncrement(settings.ControllerName, settings.Steps);
                        break;

                    case "MinSpeed":
                        returnVal = PipeServerConnection.Instance.Channel.ControllerMinSpeedIncrement(settings.ControllerName, settings.Steps);
                        break;

                    case "MaxSpeed":
                        returnVal = PipeServerConnection.Instance.Channel.ControllerMaxSpeedIncrement(settings.ControllerName, settings.Steps);
                        break;
