    ...
    public class DecrementEffectValues : PluginBase
    {
        ...
        public override void KeyReleased(KeyPayload payload)
        {
            try
            {
                ...
                {
                    case "Intensity":
                        PipeServerConnection.Instance.Channel.EffectIntensityDecrement(settings.EffectName, settings.Steps);
                        break;
                    case "Smoothness":
                        PipeServerConnection.Instance.Channel.EffectSmoothingDecrement(settings.EffectName, settings.Steps);
                        break;
                    default:
